var gLineupPageData = {
	"Team Cahill, SD" : {
		...
		team: [
				...
				{pos: "SD", name: "Solarte, 2B", team: "SD", status: "A", eppg: 7.1, fppg: 6.5, score: 3.2, timeEnd: 5, plInfo: {action: "FG 6 TYds 8.6 int 1"},},
				{pos: "SD", name: "Schimpf, 3B", team: "SD", status: "A", eppg: 5.6, fppg: 7.9, score: 2.8, timeEnd: 5, plInfo: {action: "FG 6 TYds 8.6 int 1"},},
				{pos: "SD", name: "Aybar, SS", team: "SD", status: "A", eppg: 6.2, fppg: 6.4, score: 2.4, timeEnd: 5, plInfo: {action: "FG 6 TYds 8.6 int 1"},},
				{pos: "SD", name: "Hedges, C", team: "SD", status: "A", eppg: 6.2, fppg: 3.3, score: 2.4, timeEnd: 5, plInfo: {action: "FG 6 TYds 8.6 int 1"},},
				{pos: "WAS", name: "Harper, LF", team: "WAS", status: "A", eppg: 5.2, fppg: 4.5, score: 3.1, timeEnd: 3.6, plInfo: {action: "FG 6 TYds 8.6 int 1"},},
				{pos: "DEF", name: "Renfroe RF", team: "SD", status: "A", eppg: 7.1, fppg: 7.2, score: 3.9, timeEnd: 5, plInfo: {action: "FG 6 TYds 8.6 int 1"},},
				{pos: "DEF", name: "Margot, CF", team: "SD", status: "A", eppg: 4.6, fppg: 4.9, score: 1.8, timeEnd: 5, plInfo: {action: "FG 6 TYds 8.6 int 1"},},
				{pos: "GK", name: "Cahill, P", team: "SD", status: "A", eppg: 17.2, fppg: 16.3, score: 9.4, timeEnd: 5, plInfo: {action: "FG 6 TYds 8.6 int 1"},},
			],
		TotScore: 126,
		Diff: "+32",
		Totals: {
	...
	"Team Quintana, CHI": {
		...
		team: [
				...
				{pos: "CHI", name: "Sanchez, 2B", team: "CHI", status: "A", eppg: 6.7, fppg: 7.6, score: 4.6, timeEnd: 5, plInfo: {action: "FG 6 TYds 8.6 int 1"},},
				{pos: "CHI", name: "Frazier, 3B", team: "CHI", status: "A", eppg: 5.1, fppg: 7.3, score: 2.1, timeEnd: 5, plInfo: {action: "FG 6 TYds 8.6 int 1"},},
				{pos: "CHI", name: "Anderson, SS", team: "CHI", status: "A", eppg: 6.7, fppg: 6.8, score: 3.4, timeEnd: 5, plInfo: {action: "FG 6 TYds 8.6 int 1"},},
				{pos: "CHI", name: "Soto, Ge, C", team: "CHI", status: "A", eppg: 5.9, fppg: 5.5, score: 2.5, timeEnd: 5, plInfo: {action: "FG 6 TYds 8.6 int 1"},},
				{pos: "WAS", name: "Garcia, W, LF", team: "CHI", status: "A", eppg: 9.2, fppg: 11.2, score: 4.2, timeEnd: 5, plInfo: {action: "FG 6 TYds 8.6 int 1"},},
				{pos: "DEF", name: "Judge, RF", team: "NYY", status: "A", eppg: 8.2, fppg: 6.6, score: 3.8, timeEnd: 4.3, plInfo: {action: "FG 6 TYds 8.6 int 1"},},
				{pos: "DEF", name: "Garcia, L, CF", team: "CHI", status: "A", eppg: 9.1, fppg: 9.9, score: 4.1, timeEnd: 5, plInfo: {action: "FG 6 TYds 8.6 int 1"},},
				{pos: "GK", name: "Quintana, P", team: "CHI", status: "A", eppg: 16.4, fppg: 17.6, score: 8.7, timeEnd: 5, plInfo: {action: "FG 6 TYds 8.6 int 1"},},
			],
		TotScore: 158,
		Diff: "-32",
		Totals: {
