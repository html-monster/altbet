...
*/
		...
		const formContent = ({ input, error, successMessage, format/*, data:{ data, plan, depositQuantity, pricePlan }*/, handleSubmit }) => {
            ...
            return <form action="http://localhost/AltBet.Admin/Category/TestAction" method="post" onSubmit={handleSubmit}>
...
*/}
                                    <div className="left_column column">
                                        ...
                                        <InputValidation renderContent={inputRender} id='n_name' name="NickName"
                                                         ...
                                                         validate={[emptyValidation, regexValidation.bind(null, {tmpl: /^[a-zA-Z\.\-_]+$/, message: "Allowed: symbols, digits, .-_"}), lengthValidation.bind(null, {min: 3, max: 10})]} input={input}
                                    ...
                                    <div className="right_column column">
                                        ...
                                        <InputValidation renderContent={inputRender} id='r_pass' name="Password"
                                                         className={'input__field input__field--yoshiko'}
                                                         label="Password" type='password'
                                                         validate={[emptyValidation, lengthValidation.bind(null, {min: 3, max: 20})]} input={input}/>

                                        <InputValidation renderContent={inputRender} id='r_confirm_pass' name="Password"
                                                         className={'input__field input__field--yoshiko'}
