...
export default class Preferences extends React.Component {
  ...
  render() {
    const {IsMode, IsBettor, IsTrade, MailActivity, MailFrequency, MailNews, SmsActivity, MailUpdates} = this.state.serverData;
      ...
      >
          ...
          <ul className="preferences_list color_scheme_switch">
            <li>
              <label className="change-color">
                ...
                <button className={'dark color_pick' + (globalData.theme === 'dark' ? ' active' : '')}
                        title="dark theme">{}</button>
                &nbsp;
                <button className={'light color_pick' + (globalData.theme === 'light' ? ' active' : '')}
        ...
        <section className="section">
          ...
          <ul className="preferences_list">
            ...
            <li>
              <CheckBox
                data={{className: "checkbox checkbox_horizontal", name: "MailActivity", checked: radioButtonsDisabled}}
