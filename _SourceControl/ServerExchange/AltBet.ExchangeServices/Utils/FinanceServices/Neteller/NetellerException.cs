...
namespace AltBet.ExchangeServices.Utils.FinanceServices.Neteller
{
    public class NetellerException : Exception, ISerializable
    {
        ...
        public NetellerException(string message)
            : base(message)
        {
        }

        public NetellerException(string message, Exception inner)
            : base(message, inner)
        {
        }
        ...
        public NetellerException(string message, IRestResponse response)
            : base(message)
        {
            Response = response;
            SetUserFriendlyErrorMessage(response);
        ...
        protected NetellerException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
            // Add implementation.
        }
